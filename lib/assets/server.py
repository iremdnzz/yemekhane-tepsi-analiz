...
food_data = {
    ...
    "Cigköfte": {"type": "Yardımcı Yemek", "calories": 160, "price": 33},
    ...
    "Ekmek": {"type": "Ekmek", "calories": 97.5, "price": 5},
    ...
    "Link": {"type": "İçecek", "calories": 120, "price": 33},
    "Kuru Fasulye": {"type": "Etsiz Yemek", "calories": 300, "price": 100},
    ...
    "Sekerpares": {"type": "Tatlı", "calories": 270, "price": 33},
    ...
    "Taze Fasulye": {"type": "Etsiz Yemek", "calories": 180, "price": 100},
    "Yesil Mercimek Corbasi": {"type": "Çorba", "calories": 150, "price": 26},
      "Armut": {"type": "Meyve", "calories": 60, "price": 33},
  "Baklava": {"type": "Tatlı", "calories": 350, "price": 33},
  "Browni": {"type": "Tatlı", "calories": 280, "price": 33},
  "Bulgur Pilavı": {"type": "Yardımcı Yemek", "calories": 210, "price": 33},
  "Etli Düğün Çorbası": {"type": "Çorba", "calories": 180, "price": 26},
  "Ezogelin Çorbası": {"type": "Çorba", "calories": 150, "price": 26},
  "Fırın Sütlaç": {"type": "Tatlı", "calories": 200, "price": 33},
  "Islak Kek": {"type": "Tatlı", "calories": 260, "price": 33},
  "İzmir Köfte": {"type": "Ana Yemek", "calories": 300, "price": 100},
  "Kadayıf": {"type": "Tatlı", "calories": 340, "price": 33},
  "Kısır": {"type": "Yardımcı Yemek", "calories": 170, "price": 33},
  "Kremşantili Revani": {"type": "Tatlı", "calories": 400, "price": 33},
  "Limonata": {"type": "İçecek", "calories": 90, "price": 33},
  "Makarna": {"type": "Yardımcı Yemek", "calories": 200, "price": 33},
  "Mandalina": {"type": "Meyve", "calories": 45, "price": 33},
  "Mevsim Salata": {"type": "Salata", "calories": 80, "price": 33},
  "Orman Kebabı": {"type": "Ana Yemek", "calories": 320, "price": 100},
  "Piliç Baget": {"type": "Ana Yemek", "calories": 250, "price": 100},
  "Püreli Rosto Köfte": {"type": "Ana Yemek", "calories": 360, "price": 100},
  "Revani": {"type": "Tatlı", "calories": 300, "price": 33},
  "Şehriye Çorbası": {"type": "Çorba", "calories": 140, "price": 26},
  "Soslu Makarna": {"type": "Yardımcı Yemek", "calories": 220, "price": 33},
  "Sultan Kebabı": {"type": "Ana Yemek", "calories": 400, "price": 100},
  "Tavuk Döner": {"type": "Ana Yemek", "calories": 310, "price": 100},
  "Turp Salatası": {"type": "Salata", "calories": 70, "price": 33}
